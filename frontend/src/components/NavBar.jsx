          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
              ...
              >
                ...
                <span className="absolute -top-2 -left-2 bg-emerald-500 text-white rounded-full px-2 py-0.5 text-xs group-hover:bg-emerald-400 transiton duration-300 ease-in-out ">
                  {cart.length}
                </span>
              </Link>
            )}
            ...
            {user ? (
              <Link to={"/"}>
                ...
                >
                  <LogOut size={18} />
                  <span className="hidden sm:inline ml-2">Deconnexion</span>
                </button>
              </Link>
            ) : (
              <>
                ...
                >
                  ...
                  <span className="hidden sm:inline ml-2">Inscription</span>
                </Link>
                <Link
                  to={"/login"}
                ...
                >
                  ...
                  <span className="hidden sm:inline ml-2">Connexion</span>
                </Link>
              </>
            )}
          </nav>
